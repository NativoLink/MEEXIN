...
import com.darkcode.emenu.Cliente.AdapterAbono;
 ...
 */
public class VistaAbonos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        servicio.getAbonos(id_cliente, new Callback<List<Abono>>() {
            @Override
            public void success(List<Abono> transaccions, Response response) {
                ListAdapter listAdapter = new AdapterAbono(getContext(), transaccions);
