...
/**
 * Created by NativoLink on 16/3/16.
 */
public class RegProducto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reg_producto);

        getSupportActionBar().setTitle("Meexin - Registrar Productos");
        ...
        Button btnRegP = (Button)findViewById(R.id.btnRegProducto);
        ...
        btnRegP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                servicio.postRegProducto(s_marca, s_modelo, s_descrip, i_precio, i_cant, s_foto, new Callback<String>() {
                    @Override
...
//                        Toast.makeText(getApplicationContext(), s_marca+"| "+s_modelo+" | "+s_descrip+" | "+i_cant+" |"+i_precio+" |"+s_foto, Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
