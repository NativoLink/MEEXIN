...
import com.darkcode.emenu.Login.Login;
...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,VistaProductos.OnFragmentInteractionListener,VistaPedidos.OnFragmentInteractionListener {
...
//        final Button ConfirmarP = (Button)findViewById(R.id.btnConfirmarP);
...
//        });
        ...
        Fragment vista = new VistaProductos();
...
//                ((TextView)findViewById(R.id.name)).setText(mPrinterInfo.getName());
    ...
    private void printText() {
        doJob(new Runnable() {
            ...
            public void run() {
                StringBuffer sb = new StringBuffer();
                sb.append("{reset}{center}{w}{b}Prueba Desarrollo");
                sb.append("{br}");
                sb.append("{br}");
                sb.append("{reset}1. {b}First item{br}");
                sb.append("{reset}{right}{h}$0.50 A{br}");
